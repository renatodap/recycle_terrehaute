...
- Recycling identification is AI-based and may not be 100% accurate
- Always verify with local authorities for official recycling guidelines
- Location data and schedules may change without notice
- We are not liable for incorrect disposal based on App recommendations
...
Your privacy is important. Please review our Privacy Policy for information about data collection and use.
...
- We are not responsible for recycling mistakes or environmental violations
...
- Interfere with App operations
- Scrape or harvest data
- Impersonate others
- Use for commercial waste management without Business tier

## 12. User Content

- You retain ownership of photos you take
- You grant us license to process images for service provision
- Images are not stored after analysis unless you save to history
- We may use anonymized data to improve the service

## 13. Modifications

We may modify:
- These Terms with 30-day notice
- App features at any time
- Pricing with 30-day notice
...
These Terms are governed by the laws of Indiana, USA. Disputes shall be resolved in Vigo County courts.

## 16. Accessibility

We strive to make the App accessible to all users. Contact us for accessibility concerns.

## 17. DMCA Compliance

We respect intellectual property. Report violations to legal@recycleterrehaute.org.

## 18. Export Compliance

The App may not be exported to countries under U.S. embargo.
...
- Email: support@recycleterrehaute.org
